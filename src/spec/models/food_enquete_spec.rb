...
RSpec.describe FoodEnquete, type: :model do
  ...
  describe 'アンケートの回答の条件' do
    context '年齢を確認すること' do
      it '未成年は飲み放題を選択できないこと' do
  ...
  describe 'アンケートの解答時の条件' do
    context 'メールアドレスを確認すること' do
      it '同じメールアドレスで回答できること' do
        re_enquete_tanaka = FactoryBot.build(:food_enquete_tanaka, food_id: 0, score: 1, present_id: 0,
                                                                   request: 'スープがぬるかった')
